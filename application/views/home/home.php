    ...
    <section id="nft_product_part" class="nft-product-area pt-50 pb-50">
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="single_product mt-50 pb-30">
                        ...
                        <div class="single_product_img">
                            ...
                            <a href="product.html" class="theme_preview_link">
                                <img src="<?=base_url('assets/')?>img/items/simon-lee-2FWcYzN7X_c-unsplash.jpg" alt="" class="responsive-fluid" />
                            </a>
                ...
                <div class="col-md-4 col-sm-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                    <!-- start col-4 -->
                    <div class="single_product mt-50 pb-30">
                        <!-- Single Product -->
                        ...
                        <div class="single_product_img">
                            <!-- start single product img -->
                            <a href="product.html" class="theme_preview_link">
                                <img src="<?=base_url('assets/')?>img/items/simon-lee-hbFKxsIqclc-unsplash.jpg" alt="" class="responsive-fluid" />
                            </a>
                        </div> <!-- End single product img -->
                        <div class="nft_product_description">
                            <!-- start product description -->
                            <div class="nft_product_text">
                                <ul class="author-profile-link">
                                    ...
                                    <li class="nav-item">
                                        <a href="author-details.html" class="author_link">
                                            <img src="<?=base_url('assets/')?>img/avatar/3.jpg" alt="author" class="responsive-fluid img-1" />
                                            <i class='bx bxs-check-circle'></i>
                                        </a>
                                        <span class="hover_author_link">
                ...
                <div class="col-md-4 col-sm-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".7s">
                    <!-- start col-4 -->
                    <div class="single_product mt-50 pb-30">
                        <!-- Single Product -->
                        <div class="jumbotron countdown show" data-Date='2022/02/24 23:59:59' data-endText="Auction ended">
                            <div class="running">
                                <span class="timer">
                                    <span class="days"></span>d
                                    <span class="hours"></span>h
                        ...
                        <div class="single_product_img">
                            <!-- start single product img -->
                            <a href="product.html" class="theme_preview_link">
                                <img src="<?=base_url('assets/')?>img/items/simon-lee-ynmPY1MLwMs-unsplash.jpg" alt="" class="responsive-fluid" />
                            </a>
                        </div> <!-- End single product img -->
                        <div class="nft_product_description">
                            <!-- start product description -->
                            <div class="nft_product_text">
                                <ul class="author-profile-link">
                                    ...
                                    <li class="nav-item">
                                        <a href="author-details.html" class="author_link offline">
                                            <img src="<?=base_url('assets/')?>img/avatar/5.jpg" alt="author" class="responsive-fluid img-2" />
                                            <i class='bx bxs-check-circle'></i>
                                        </a>
                                        <span class="hover_author_link">
                ...
                <div class="col-md-4 col-sm-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                    ...
                    <div class="single_product mt-50 pb-30">
                        ...
                        <div class="single_product_img">
                            <!-- start single product img -->
                            <a href="product.html" class="theme_preview_link">
                                <img src="<?=base_url('assets/')?>img/items/simon-lee-IEgvy4o3byM-unsplash.jpg" alt="" class="responsive-fluid" />
                            </a>
                        </div> <!-- End single product img -->
                        <div class="nft_product_description">
                            <!-- start product description -->
                        ...
                        <div class="nft_product_description">
                            ...
                            <div class="nft_product_text">
                                <ul class="author-profile-link">
                                    ...
                                    <li class="nav-item">
                                        <a href="author-details.html" class="author_link">
                                            <img src="<?=base_url('assets/')?>img/avatar/6.jpg" alt="author" class="responsive-fluid img-1" />
                                            <i class='bx bxs-check-circle'></i>
                                        </a>
                                        <span class="hover_author_link">
                                            <a href="author-details.html" class="author_link_text">@boobly</a>
                                        </span>
                                    </li>
                                    <li class="nav-item">
                                        <a href="author-details.html" class="author_link">
                                        ...
                                        <span class="hover_author_link">
                                            <a href="author-details.html" class="author_link_text">@yangia</a>
                                        </span>
                                    </li>
                                </ul>
                            </div><!-- end author-->
                            <div class="product_title_link">
                                <!-- start product title-->
                                <a class="product-title" href="#">
                                    <h6 class="product_title_intro">Natural Robotic Art</h6>
                                </a>
                            </div><!-- end product title-->
                        </div><!-- end product text -->
                        <div class="nft_product_link">
                            ...
                            <ul>
                                ...
                                <li class="product-all-icon">
                                    <span class="sale-count product-icon">
                                        <span class="sale-counter">Unit : 52 ETH 1/10</span>
                                    </span>
                                </li>
                            </ul>
                        </div><!-- end product link -->
                            ...
                            <div class="nft_product_text">
                                <ul class="author-profile-link">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <span class="hover_author_link">
                                            <a href="author-details.html" class="author_link_text">@watson03</a>
                                        </span>
                                    </li>
                                    <li class="nav-item">
                                        <a href="author-details.html" class="author_link">
                                        ...
                                        <span class="hover_author_link">
                                            <a href="author-details.html" class="author_link_text">@devidviya</a>
                                        </span>
                                    </li>
                                </ul>
                            </div><!-- end author-->
            ...
            <div class="row">
                    ...
                    <div class="single-author-area">
                        ...
                        <div class="single-author-img">
                            ...
                            <div class="name-amount">
                                <a href="author-details.html" class="author_link_text">@yanila7</a>
                                <p class="eth-amount"> <span class="total-items">Total items : </span>5</p>
                            </div>
                        </div><!-- end single author image -->
                        <div class="copy-icon-otr single-author-copy">
                            <div id="wallet0" class="profile_wallet text heading-SB">W1HPa7K7f865Kk4LqnrME</div>
                ...
                <div class="col-md-3 col-sm-6 mb-30 mt-20">
                    ...
                    <div class="single-author-area">
                        ...
                        <div class="single-author-img">
                            ...
                            <div class="name-amount">
                                <a href="author-details.html" class="author_link_text">@gonjila</a>
                                <p class="eth-amount"> <span class="total-items">Total items : </span>5</p>
                            </div>
                        </div><!-- end single author image -->
                        <div class="copy-icon-otr single-author-copy">
                            <div id="wallet2" class="profile_wallet text heading-SB">MSxb9oW1HPa7K7f865Kk4LqnrME</div>
                            <a href="#" class="btn_copy_link" title="Copy Text">
                                <i class="bx bx-copy-alt"></i>
                            </a>
                        </div><!-- end copy link -->
                ...
                <div class="col-md-3 col-sm-6 mb-30 mt-20">
                    ...
                    <div class="single-author-area">
                        ...
                        <div class="single-author-img">
                            ...
                            <div class="name-amount">
                                <a href="author-details.html" class="author_link_text">@thumpee</a>
                                <p class="eth-amount"> <span class="total-items">Total items : </span>5</p>
                            </div>
                        </div><!-- end single author image -->
                        <div class="copy-icon-otr single-author-copy">
                            <div id="wallet3" class="profile_wallet text heading-SB">DdzFFzCW1HPa7K7f865Kk4LqnrME</div>
                            <a href="#" class="btn_copy_link" title="Copy Text">
                                <i class="bx bx-copy-alt"></i>
                            </a>
                        </div><!-- end copy link -->
                ...
                <div class="col-md-3 col-sm-6 mb-30 mt-20">
                    ...
                    <div class="single-author-area">
                        ...
                        <div class="copy-icon-otr single-author-copy">
                            <div id="wallet4" class="profile_wallet text heading-SB">CqrhshMSxb9oW1HPa7K7f865Kk4LqnrME
                            </div>
                            <a href="#" class="btn_copy_link" title="Copy Text">
                                <i class="bx bx-copy-alt"></i>
                            </a>
                ...
                <div class="col-md-3 col-sm-6 mb-30 mt-20">
                    ...
                    <div class="single-author-area">
                        ...
                        <div class="single-author-img">
                            ...
                            <div class="name-amount">
                                <a href="author-details.html" class="author_link_text">@manila7</a>
                                <p class="eth-amount"> <span class="total-items">Total items : </span>5</p>
                            </div>
                        </div><!-- end single author image -->
                        <div class="copy-icon-otr single-author-copy">
                            <div id="wallet5" class="profile_wallet text heading-SB">FzCqrhshMSxb9oW1HPa7K7f865Kk4LqnrME
                            </div>
                            <a href="#" class="btn_copy_link" title="Copy Text">
                                <i class="bx bx-copy-alt"></i>
                            </a>
                ...
                <div class="col-md-3 col-sm-6 mb-30 mt-20">
                    ...
                    <div class="single-author-area">
                        ...
                        <div class="single-author-img">
                            ...
                            <div class="name-amount">
                                <a href="author-details.html" class="author_link_text">@yanila32</a>
                                <p class="eth-amount"> <span class="total-items">Total items : </span>5</p>
                            </div>
                        </div><!-- end single author image -->
                        <div class="copy-icon-otr single-author-copy">
                            <div id="wallet6" class="profile_wallet text heading-SB">Sxb9oW1HPa7K7f865Kk4LqnrME</div>
                            <a href="#" class="btn_copy_link" title="Copy Text">
                                <i class="bx bx-copy-alt"></i>
                            </a>
                        </div><!-- end copy link -->
                ...
                <div class="col-md-3 col-sm-6 mb-30 mt-20">
                    ...
                    <div class="single-author-area">
                        ...
                        <div class="single-author-img">
                            ...
                            <div class="name-amount">
                                <a href="author-details.html" class="author_link_text">@yonila_01</a>
                                <p class="eth-amount"> <span class="total-items">Total items : </span>5</p>
                            </div>
                        </div><!-- end single author image -->
                        <div class="copy-icon-otr single-author-copy">
                            <div id="wallet7" class="profile_wallet text heading-SB">
                                FFzCqrhshMSxb9oW1HPa7K7f865Kk4LqnrME</div>
                            <a href="#" class="btn_copy_link" title="Copy Text">
                                <i class="bx bx-copy-alt"></i>
                            </a>
                        </div><!-- end copy link -->
                ...
                <div class="col-md-3 col-sm-6 mb-30 mt-20">
                    ...
                    <div class="single-author-area">
                        ...
                        <div class="single-author-img">
                            <a href="author-details.html" class="author_link">
                                <img src="<?=base_url('assets/')?>img/avatar/8.jpg" alt="author" class="responsive-fluid img-1">
                                <i class="bx bxs-check-circle"></i>
                            </a>
                            <div class="name-amount">
                                <a href="author-details.html" class="author_link_text">@tosiyo45</a>
                                <p class="eth-amount"> <span class="total-items">Total items : </span>5</p>
                            </div>
                        </div><!-- end single author image -->
                        <div class="copy-icon-otr single-author-copy">
                            <div id="wallet8" class="profile_wallet text heading-SB">HPa7K7f865Kk4LqnrME</div>
                            <a href="#" class="btn_copy_link" title="Copy Text">
                                <i class="bx bx-copy-alt"></i>
                            </a>
                        </div><!-- end copy icon -->
    ...
    <section class="promo-area">
        ...
        <div class="container container-bg">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <!-- start col -->
                    <div class="image-right wow fadeInRight" data-wow-duration="1s" data-wow-delay=".5s">
    ...
    <div id="nftproduct_part" class="nftproduct_collection pb-170">
        <!-- start collection product -->
        <div class="container pt-80">
            <!-- start container -->
            <div class="row wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".4s">
                <!-- start row -->
                <div class="col-md-6 col-sm-12">
                    <div class="section_intro wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                        <p class="section_top_title">Collection</p>
                        <h2 class="section_heading">Collection Resources</h2>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                    <div class="section_description">
                        <p class="wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".5s"> Once you’ve set up your
                            wallet of choice, please let you connect it to NFT Marketplace in the top right corner.
        ...
        <div class="container slick-container">
            ...
            <div class="slick-slider-area">
                <!-- Start slider -->
                <div class="single_product item_collection mt-50 pb-30">
                    <!-- Single Product -->
                    <div class="jumbotron countdown show" data-Date='2021/12/24 23:59:59' data-endText="Auction ended">
                        <div class="running">
                            <span class="timer">
                    ...
                    <div class="single_product_img">
                        ...
                        <div class="item-collection-img">
                            <!-- start item collection img -->
                            <a href="img/items/1.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/1.jpg" alt="" class="responsive-fluid" />
                            </a>
                            <a href="img/items/2.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/2.jpg" alt="" class="responsive-fluid" />
                            </a>
                            <a href="img/items/3.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/3.jpg" alt="" class="responsive-fluid" />
                            </a>
                    ...
                    <div class="nft_product_description">
                        <!-- start product description -->
                        <div class="nft_product_text">
                            <div class="author-profile-link slider_collection_author">
                                <!-- start author-->
                                <span class="collection-create">4 items. Created by</span>
                                <a href="author-details.html" class="author_link author-slider">
                                    <img src="<?=base_url('assets/')?>img/avatar/1.jpg" alt="author" class="responsive-fluid img-1">
                                    <i class="bx bxs-check-circle"></i>
                                </a>
                        ...
                        <div class="product_title_link slider_item">
                            <!-- start product title-->
                            <a class="product-title" href="#">
                                <h6 class="product_title_intro">Mysterious Robotic Art Collection</h6>
                            </a>
                        </div><!-- end product title-->
                    ...
                    <div class="nft_product_link pt-20 pb-10">
                        ...
                        <ul>
                            ...
                            <li class="product-all-icon">
                                <span class="report-icon product-icon">
                                    <a href="#" class="report-link placebid slider-bid price" data-toggle="modal" data-target="#popup_bid">
                            ...
                            <li class="product-all-icon">
                                <span class="sale-count product-icon">
                                    <span class="sale-counter">Unit : 145 ETH 1/4</span>
                                </span>
                            </li>
                        </ul>
                    </div><!-- end product link -->
                ...
                <div class="single_product item_collection mt-50 pb-30">
                    <!-- Single Product -->
                    <div class="jumbotron countdown show" data-Date='2021/10/24 23:59:59' data-endText="Auction ended">
                        <div class="running">
                            <span class="timer">
                                <span class="days"></span>d
                                <span class="hours"></span>h
                    ...
                    <div class="single_product_img">
                        ...
                        <div class="item-collection-img">
                            <!-- start item collection img -->
                            <a href="<?=base_url('assets/')?>img/items/4.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/4.jpg" alt="" class="responsive-fluid" />
                            </a>
                            <a href="<?=base_url('assets/')?>img/items/5.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/5.jpg" alt="" class="responsive-fluid" />
                            </a>
                            <a href="<?=base_url('assets/')?>img/items/6.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/6.jpg" alt="" class="responsive-fluid" />
                            </a>
                        </div><!-- end item collection img -->
                    </div> <!-- End single product img -->
                    <div class="nft_product_description">
                        ...
                        <div class="nft_product_text">
                            <div class="author-profile-link slider_collection_author">
                                <!-- start author-->
                                <span class="collection-create">3 items. Created by</span>
                                <a href="author-details.html" class="author_link author-slider">
                                    <img src="<?=base_url('assets/')?>img/avatar/3.jpg" alt="author" class="responsive-fluid img-1">
                                    <i class="bx bxs-check-circle"></i>
                                </a>
                        ...
                        <div class="product_title_link slider_item">
                            <!-- start product title-->
                            <a class="product-title" href="#">
                                <h6 class="product_title_intro">Collection of 3D Art Work</h6>
                            </a>
                        </div><!-- end product title-->
                    </div><!-- end product description -->
                    <div class="nft_product_link pt-20 pb-10">
                        ...
                        <ul>
                            ...
                            <li class="product-all-icon">
                                <span class="sale-count product-icon">
                                    <span class="sale-counter">Unit : 405 ETH 1/3</span>
                                </span>
                            </li>
                        </ul>
                    </div><!-- end product link -->
                ...
                <div class="single_product item_collection mt-50 pb-30">
                    <!-- Single Product -->
                    <div class="jumbotron countdown show" data-Date='2021/11/20 23:59:59' data-endText="Auction ended">
                        <div class="running">
                            <span class="timer">
                                <span class="days"></span>d
                                <span class="hours"></span>h
                    ...
                    <div class="single_product_img">
                        ...
                        <div class="item-collection-img">
                            <!-- start item collection img -->
                            <a href="<?=base_url('assets/')?>img/items/2.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/2.jpg" alt="" class="responsive-fluid" />
                            </a>
                            <a href="<?=base_url('assets/')?>img/items/7.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/7.jpg" alt="" class="responsive-fluid" />
                            </a>
                            <a href="<?=base_url('assets/')?>img/items/8.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/8.jpg" alt="" class="responsive-fluid" />
                            </a>
                        </div><!-- end item collection img -->
                    </div> <!-- End single product img -->
                    <div class="nft_product_description">
                        ...
                        <div class="product_title_link slider_item">
                            <!-- start product title-->
                            <a class="product-title" href="#">
                                <h6 class="product_title_intro">Natural Space Fusion</h6>
                            </a>
                        </div><!-- end product title-->
                    </div><!-- end product description -->
                    <div class="nft_product_link pt-20 pb-10">
                        ...
                        <ul>
                            ...
                            <li class="product-all-icon">
                                <span class="sale-count product-icon">
                                    <span class="sale-counter">Unit : 105 ETH 1/4</span>
                                </span>
                            </li>
                        </ul>
                    </div><!-- end product link -->
                ...
                <div class="single_product item_collection mt-50 pb-30">
                    ...
                    <div class="single_product_img">
                        ...
                        <div class="item-collection-img">
                            <!-- start item collection img -->
                            <a href="<?=base_url('assets/')?>img/items/12.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/12.jpg" alt="" class="responsive-fluid" />
                            </a>
                            <a href="<?=base_url('assets/')?>img/items/11.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/11.jpg" alt="" class="responsive-fluid" />
                            </a>
                            <a href="<?=base_url('assets/')?>img/items/3.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/3.jpg" alt="" class="responsive-fluid" />
                            </a>
                        </div><!-- end item collection img -->
                    </div> <!-- End single product img -->
                    <div class="nft_product_description">
                        ...
                        <div class="nft_product_text">
                            <div class="author-profile-link slider_collection_author">
                                <!-- start author-->
                                <span class="collection-create">5 items. Created by</span>
                                <a href="author-details.html" class="author_link author-slider">
                                    <img src="<?=base_url('assets/')?>img/avatar/3.jpg" alt="author" class="responsive-fluid img-1">
                                    <i class="bx bxs-check-circle"></i>
                                </a>
                        ...
                        <div class="product_title_link slider_item">
                            <!-- start product title-->
                            <a class="product-title" href="#">
                                <h6 class="product_title_intro">Colorful Abstract Painting</h6>
                            </a>
                        </div><!-- end product title-->
                    </div><!-- end product description -->
                    <div class="nft_product_link pt-20 pb-10">
                        ...
                        <ul>
                            ...
                            <li class="product-all-icon">
                                <span class="sale-count product-icon">
                                    <span class="sale-counter">Unit : 165 ETH 1/4</span>
                                </span>
                            </li>
                        </ul>
                    </div><!-- end product link -->
                ...
                <div class="single_product item_collection mt-50 pb-30">
                    ...
                    <div class="single_product_img">
                        ...
                        <div class="item-collection-img">
                            <!-- start item collection img -->
                            <a href="<?=base_url('assets/')?>img/items/1.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/1.jpg" alt="" class="responsive-fluid" />
                            </a>
                            <a href="img/items/4.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/4.jpg" alt="" class="responsive-fluid" />
                            </a>
                            <a href="img/items/9.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/9.jpg" alt="" class="responsive-fluid" />
                            </a>
                        </div><!-- end item collection img -->
                    </div> <!-- End single product img -->
                    <div class="nft_product_description">
                        ...
                        <div class="nft_product_text">
                            <div class="author-profile-link slider_collection_author">
                                ...
                                <span class="collection-create">3 items. Created by</span>
                                <a href="author-details.html" class="author_link author-slider">
                                    <img src="<?=base_url('assets/')?>img/avatar/12.jpg" alt="author" class="responsive-fluid img-1">
                                    <i class="bx bxs-check-circle"></i>
                                </a>
                            </div>
                        </div><!-- end author-->
                        <div class="product_title_link slider_item">
                            <!-- start product title-->
                            <a class="product-title" href="#">
                                <h6 class="product_title_intro">Modern Art collection</h6>
                            </a>
                        </div><!-- end product title-->
                    </div><!-- end product description -->
                    <div class="nft_product_link pt-20 pb-10">
                ...
                <div class="single_product item_collection mt-50 pb-30">
                    ...
                    <div class="single_product_img">
                        ...
                        <div class="item-collection-img">
                            ...
                            <a href="<?=base_url('assets/')?>img/items/10.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/10.jpg" alt="" class="responsive-fluid" />
                            </a>
                            <a href="<?=base_url('assets/')?>img/items/6.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/6.jpg" alt="" class="responsive-fluid" />
                    ...
                    <div class="nft_product_description">
                        ...
                        <div class="nft_product_text">
                            <div class="author-profile-link slider_collection_author">
                                <!-- start author-->
                                <span class="collection-create">2 items. Created by</span>
                                <a href="author-details.html" class="author_link author-slider">
                                    <img src="<?=base_url('assets/')?>img/avatar/11.jpg" alt="author" class="responsive-fluid img-1">
                                    <i class="bx bxs-check-circle"></i>
                                </a>
                                <a href="author-details.html" class="author_link author-slider offline">
                                    <img src="<?=base_url('assets/')?>img/avatar/2.jpg" alt="author" class="responsive-fluid img-1">
                        ...
                        <div class="product_title_link slider_item">
                            <!-- start product title-->
                            <a class="product-title" href="#">
                                <h6 class="product_title_intro">Creative Art collection</h6>
                            </a>
                        </div><!-- end product title-->
                    </div><!-- end product description -->
                    <div class="nft_product_link pt-20 pb-10">
                        ...
                        <ul>
                            ...
                            <li class="product-all-icon">
                                <span class="sale-count product-icon">
                                    <span class="sale-counter">Unit : 45 ETH 1/4</span>
                                </span>
                            </li>
                        </ul>
                    </div><!-- end product link -->
                    ...
                    <div class="nft_product_description">
                        ...
                        <div class="nft_product_text">
                            <div class="author-profile-link slider_collection_author">
                                ...
                                <a href="author-details.html" class="author_link author-slider offline">
                                    <img src="<?=base_url('assets/')?>img/avatar/9.jpg" alt="author" class="responsive-fluid img-1">
                                    <i class="bx bxs-check-circle"></i>
                                </a>
                            </div>
                        </div><!-- end author-->
                        <div class="product_title_link slider_item">
                            <!-- start product title-->
                            <a class="product-title" href="#">
                                <h6 class="product_title_intro">Contemporary Art collection</h6>
                            </a>
                        </div><!-- end product title-->
                    </div><!-- end product description -->
                    <div class="nft_product_link pt-20 pb-10">
                        ...
                        <ul>
                            ...
                            <li class="product-all-icon">
                                <span class="sale-count product-icon">
                                    <span class="sale-counter">Unit : 76 ETH 1/3</span>
                                </span>
                            </li>
                        </ul>
                    </div><!-- end product link -->
                ...
                <div class="single_product item_collection mt-50 pb-30">
                    ...
                    <div class="nft_product_description">
                        ...
                        <div class="product_title_link slider_item">
                            <!-- start product title-->
                            <a class="product-title" href="#">
                                <h6 class="product_title_intro">Mysterious Art Collection</h6>
                            </a>
                        </div><!-- end product title-->
                    </div><!-- end product description -->
                    <div class="nft_product_link pt-20 pb-10">
                ...
                <div class="single_product item_collection mt-50 pb-30">
                    <!-- Single Product -->
                    <div class="jumbotron countdown show" data-Date='2021/11/24 23:59:59' data-endText="Auction ended">
                        <div class="running">
                            <span class="timer">
                                <span class="days"></span>d
                                <span class="hours"></span>h
                    ...
                    <div class="single_product_img">
                        ...
                        <div class="item-collection-img">
                            ...
                            <a href="<?=base_url('assets/')?>img/items/9.jpg" class="item-popup">
                                <img src="<?=base_url('assets/')?>img/items/9.jpg" alt="" class="responsive-fluid" />
                            </a>
                        </div><!-- end item collection img -->
                    </div> <!-- End single product img -->
                    <div class="nft_product_description">
                        ...
                        <div class="nft_product_text">
                            <div class="author-profile-link slider_collection_author">
                                ...
                                <a href="author-details.html" class="author_link author-slider">
                                    <img src="<?=base_url('assets/')?>img/avatar/10.jpg" alt="author" class="responsive-fluid img-1">
                                    <i class="bx bxs-check-circle"></i>
                                </a>
                            </div>
                        </div><!-- end author-->
                        <div class="product_title_link slider_item">
                            <!-- start product title-->
                            <a class="product-title" href="#">
                                <h6 class="product_title_intro">Creative 3D Art Collection</h6>
                            </a>
                        </div><!-- end product title-->
                    </div><!-- end product description -->
                    <div class="nft_product_link pt-20 pb-10">
                        ...
                        <ul>
                            ...
                            <li class="product-all-icon">
                                <span class="sale-count product-icon">
                                    <span class="sale-counter">Unit : 140 ETH 1/4</span>
                                </span>
                            </li>
                        </ul>
                    </div><!-- end product link -->
    ...
    <section class="feature-author-list-area pt-50 pb-50">
        <!-- start author list area -->
        <div class="container pt-50 mb-20">
            <!-- start container -->
            <div class="row">
                ...
                <div class="col-md-7 col-sm-12 pb-30">
                    <div class="section_intro wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                        ...
                        <div class="section_description">
                            <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">Explore on the world's
                                best & largest NFT marketplace with our beautiful NFT products. We want to be a part of
                                your smile. </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-5 float-right col-sm-12">
                    <div class="author-btn">
                        <a href="authors.html" class="btn btn_authors">All Authors <i class="bx bx-arrow-back"></i></a>
                    </div>
                </div>
            </div><!-- end row -->
        </div><!-- end container -->
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 mb-30 mt-20">
                    ...
                    <div class="single-author-area">
                        ...
                        <div class="follow-icon-otr single-author-btn text-center">
