            ...
            <div class="row">
                <div class="col-md-12 text-center pt-200 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                    ...
                    <ul class="breadcrumb-menu clearfix">
                        <li>
                            <a href="<?=base_url('/')?>">Home /</a> <a href="#" class="active">Signup</a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <form id="account-form" method="post">
                                    <div class="row">
                                        <div class="form-group account_input col-md-12 pb-10">
                                            <input minlength="3" maxlength="100" type="email" name="email" class="form-control account_style" id="email" placeholder="Email here" required="required">
                                            <span class="text-danger"><?php echo form_error('email'); ?></span>
                                        </div>
                                        <div class="form-group account_input col-md-12 pb-10">
                                            <input minlength="3" maxlength="100" type="text" name="username" class="form-control account_style" id="username" placeholder="User name" required="required">
                                            <span class="text-danger"><?php echo form_error('username'); ?></span>
                                        </div>
                                        <div class="form-group account_input col-md-12 pb-10">
                                            <input minlength="6" maxlength="20" type="password" name="password" class="form-control account_style" id="password" placeholder="Password" required="required">
